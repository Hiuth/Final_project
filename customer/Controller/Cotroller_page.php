...
<div>
    <div>
        ...
        <div class="page-title-wall">
            <div class="page-title">
                <div class="left-title">
                    <h1>TAY CẦM CHƠI GAME</h1>
                </div>
                <div class="right-title">
                    <form action="./Cotroller_page.php" method="GET">
        ...
        <div class="main-content">
            ...
            $category_id =["Thẻ game nintendo","Xbox","Playstation4","Playstation5","Đĩa game Ps4","Đĩa game Ps5","NintendoSwtich"];
