...
<div>
    <div>
        ...
        <div class="page-title-wall">
            <div class="page-title">
                <div class="left-title">
                    <h1>TAY CẦM CHƠI GAME PS5</h1>
                </div>
                <div class="right-title">
                    <form action="./Ps5_cotroller.php" method="GET">
        ...
        <div class="main-content">
            ...
            $category_id =["Thẻ game nintendo","Xbox","Playstation4","Playstation5","Đĩa game Ps4","Đĩa game Ps5","NintendoSwtich","Tay cầm Xbox","Tay cầm Nintendo"];
