...
<div>
    <div>
        ...
        <div class="page-title-wall">
            <div class="page-title">
                <div class="left-title">
                    <h1>TAY CẦM CHƠI GAME NINTENDO SWITCH</h1>
                </div>
                <div class="right-title">
                    <form action="./Nintendo_cotroller.php" method="GET">
        ...
        <div class="main-content">
            ...
            $category_id =["Thẻ game nintendo","Xbox","Playstation4","Playstation5","Đĩa game Ps4","Đĩa game Ps5","NintendoSwtich","Tay cầm Xbox","Tay cầm Ps5"];
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="info">
                ...
                <a href="../quy_dinh_chung.html">
                    <p>- Quy định chung</p>
                </a>
                <a href="../quy_dinh_dat_tra_gop.html">
                    <p>- Quy định đặt cọc</p>
                </a>
                <a href="../quy_dinh_bao_hanh.html">
                    <p>- Quy định bảo hành</p>
                </a>
                <a href="../quy_dinh_van_chuyen.html">
                    <p>- Chính sách vận chuyển</p>
                </a>
                <a href="../quy_dinh_doi_tra.html">
