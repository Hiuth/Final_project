...
<div>
    <div>
        ...
        <div class="page-title-wall">
            <div class="page-title">
                ...
                <div class="right-title">
                    <form action="Xbox_page.php" method="GET">
        ...
        <div class="main-content">
            ...
            $category_id =["Playstation4","Playstation5","Tay cầm Ps5","Đĩa game Ps4","Đĩa game Ps5","Thẻ game Nintendo","NintendoSwtich","Tay cầm Nintendo"];
