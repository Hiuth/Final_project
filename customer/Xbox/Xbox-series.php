...
<div>
    <div>
        ...
        <div class="page-title-wall">
            <div class="page-title">
                <div class="left-title">
                    <h1>MÁY MICROSOFT XBOX</h1>
                </div>
                <div class="right-title">
                    <form action="Xbox-series.php" method="GET">
        ...
        <div class="main-content">
            ...
            $category_id =["Tay cầm xbox","Playstation4","Playstation5","Tay cầm Ps5","Đĩa game Ps4","Đĩa game Ps5","Thẻ game Nintendo","NintendoSwtich","Tay cầm Nintendo"];
